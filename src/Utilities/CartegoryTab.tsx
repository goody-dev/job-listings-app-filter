const CartegoryTab = ({cartegory}:any) => {
  return (
    <div className="cartegory-tab">
      <div className="tab-category-div">{cartegory}</div>
      <div className="tab-cancel-div">
